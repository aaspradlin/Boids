...
/** This class is used to determine how to change the velocity of a boid. */
public class HCVectorSet : VectorSet {
	
	/** The script containing coefficient information. */
	...
	/** Updates the struct that stores special groups of interest within the flock. */
	...
	/* Returns the offset gotten from the position of the flock. 
	 * This vector is relative to the bird's own position. */
	...
	/* Returns the offset gotten from the positions of birds in the passed list. 
	 * This vector is relative to the bird's own position. */
	...
	/* Returns the offset gotten from the velocities of birds in the passed list.
	 * This vector is relative to the bird's own velocity. */
	...
	/* Returns a vector attracting the bird to one point in space. */
	...
	/* Returns a vector constraining the bird to a bounding box. */
